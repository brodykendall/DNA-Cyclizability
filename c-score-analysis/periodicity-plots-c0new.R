...
ggsave("figures/periodicity/tiling_AT_q1vq4_newC0.png", plot = tiling_AT_q1vq4_newC0)
...
ggsave("figures/periodicity/tiling_AT_q2vq3_newC0.png", plot = tiling_AT_q2vq3_newC0)
...
ggsave("figures/periodicity/tiling_AATT_q1vq4_newC0.png", plot = tiling_AATT_q1vq4_newC0)
...
ggsave("figures/periodicity/tiling_AATT_q2vq3_newC0.png", plot = tiling_AATT_q2vq3_newC0)
...
ggsave("figures/periodicity/tiling_AT_topvbot1000_newC0.png", plot = tiling_AT_topvbot1000_newC0)
...
ggsave("figures/periodicity/tiling_AATT_topvbot1000_newC0.png", plot = tiling_AATT_topvbot1000_newC0)
...
dat_random_library = readRDS("data/Created/processed_random_newC0.rds")
...
ggsave("figures/periodicity/random_AT_q1vq4_newC0.png", plot = random_AT_q1vq4_newC0)
...
ggsave("figures/periodicity/random_AT_q2vq3_newC0.png", plot = random_AT_q2vq3_newC0)
...
ggsave("figures/periodicity/random_AATT_q1vq4_newC0.png", plot = random_AATT_q1vq4_newC0)
...
ggsave("figures/periodicity/random_AATT_q2vq3_newC0.png", plot = random_AATT_q2vq3_newC0)
...
ggsave("figures/periodicity/random_AT_topvbot1000_newC0.png", plot = random_AT_topvbot1000_newC0)
...
ggsave("figures/periodicity/random_AATT_topvbot1000_newC0.png", plot = random_AATT_topvbot1000_newC0)
...
ggsave("figures/periodicity/random_AT_topvbothalf_newC0.png", plot = random_AT_topvbothalf_newC0)
...
ggsave("figures/periodicity/random_AATT_topvbothalf_newC0.png", plot = random_AATT_topvbothalf_newC0)
...
dat_chrV_library = readRDS("data/Created/processed_chrV_newC0.rds")
...
chrV_AT_q1vq4_newC0
ggsave("figures/periodicity/chrV_AT_q1vq4_newC0.png", plot = chrV_AT_q1vq4_newC0)
chrV_AT_q2vq3_newC0 = ggplot(data = A_T_q_chrV_library, aes(x = 1:50)) +
  ...
  labs(title = "Average A/T Content by Position in chrV Library, New C0")
chrV_AT_q2vq3_newC0
ggsave("figures/periodicity/chrV_AT_q2vq3_newC0.png", plot = chrV_AT_q2vq3_newC0)
...
ggsave("figures/periodicity/chrV_AATT_q1vq4_newC0.png", plot = chrV_AATT_q1vq4_newC0)
...
ggsave("figures/periodicity/chrV_AATT_q2vq3_newC0.png", plot = chrV_AATT_q2vq3_newC0)
...
ggsave("figures/periodicity/chrV_AT_topvbot1000_newC0.png", plot = chrV_AT_topvbot1000_newC0)
...
ggsave("figures/periodicity/chrV_AATT_topvbot1000_newC0.png", plot = chrV_AATT_topvbot1000_newC0)
...
dat_yeast_library = readRDS("data/Created/processed_yeast_newC0.rds")
...
ggsave("figures/periodicity/yeast_AT_q1vq4_newC0.png", plot = yeast_AT_q1vq4_newC0)
...
ggsave("figures/periodicity/yeast_AT_q2vq3_newC0.png", plot = yeast_AT_q2vq3_newC0)
...
ggsave("figures/periodicity/yeast_AATT_q1vq4_newC0.png", plot = yeast_AATT_q1vq4_newC0)
...
ggsave("figures/periodicity/yeast_AATT_q2vq3_newC0.png", plot = yeast_AATT_q2vq3_newC0)
...
ggsave("figures/periodicity/yeast_AT_topvbot1000_newC0.png", plot = yeast_AT_topvbot1000_newC0)
...
ggsave("figures/periodicity/yeast_AATT_topvbot1000_newC0.png", plot = yeast_AATT_topvbot1000_newC0)
...
ggsave("figures/periodicity/yeast_AT_topvbothalf_newC0.png", plot = yeast_AT_topvbothalf)
...
ggsave("figures/periodicity/yeast_AATT_topvbothalf_newC0.png", plot = yeast_AATT_topvbothalf)
