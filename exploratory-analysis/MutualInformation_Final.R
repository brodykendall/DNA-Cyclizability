...
dat_tiling = readRDS("~/Documents/Northwestern/DNA_Cyclizability/data/Created/processed.rds")
dat_random = readRDS("~/Documents/Northwestern/DNA_Cyclizability/data/Created/processed_random_library.rds")


### TILING LIBRARY:


cutoffs_0_25_tiling = quantile(dat_tiling$C0, c(0, 0.25)) 
cutoffs_25_50_tiling = quantile(dat_tiling$C0, c(0.25, 0.5))
cutoffs_50_75_tiling = quantile(dat_tiling$C0, c(0.5, 0.75))
cutoffs_75_100_tiling = quantile(dat_tiling$C0, c(0.75, 1))

# First Quartile:
dat_q1_tiling = dat_tiling %>%
  filter(C0 >= cutoffs_0_25_tiling[1] & C0 <= cutoffs_0_25_tiling[2]) %>%
...
dat_q2_tiling = dat_tiling %>%
  filter(C0 >= cutoffs_25_50_tiling[1] & C0 <= cutoffs_25_50_tiling[2]) %>%
  select(all_of(ps1), all_of(ps2), C0)
...
dat_q3_tiling = dat_tiling %>%
  filter(C0 >= cutoffs_50_75_tiling[1] & C0 <= cutoffs_50_75_tiling[2]) %>%
  select(all_of(ps1), all_of(ps2), C0)
...
dat_q4_tiling = dat_tiling %>%
  filter(C0 >= cutoffs_75_100_tiling[1] & C0 <= cutoffs_75_100_tiling[2]) %>%
  select(all_of(ps1), all_of(ps2), C0)
...
ggsave("~/Documents/Northwestern/DNA_Cyclizability/figures/mutual_information/tiling_ps2_q1_heatmap.png", plot = map_q1_tiling)
ggsave("~/Documents/Northwestern/DNA_Cyclizability/figures/mutual_information/tiling_ps2_q2_heatmap.png", plot = map_q2_tiling)
ggsave("~/Documents/Northwestern/DNA_Cyclizability/figures/mutual_information/tiling_ps2_q3_heatmap.png", plot = map_q3_tiling)
ggsave("~/Documents/Northwestern/DNA_Cyclizability/figures/mutual_information/tiling_ps2_q4_heatmap.png", plot = map_q4_tiling)
...
cutoffs_0_25_random = quantile(dat_random$C0, c(0, 0.25)) 
cutoffs_25_50_random = quantile(dat_random$C0, c(0.25, 0.5))
cutoffs_50_75_random = quantile(dat_random$C0, c(0.5, 0.75))
cutoffs_75_100_random = quantile(dat_random$C0, c(0.75, 1))

# First Quartile:
dat_q1_random = dat_random %>%
  filter(C0 >= cutoffs_0_25_random[1] & C0 <= cutoffs_0_25_random[2]) %>%
  select(all_of(ps1), all_of(ps2), C0)
...
dat_q2_random = dat_random %>%
  filter(C0 >= cutoffs_25_50_random[1] & C0 <= cutoffs_25_50_random[2]) %>%
  select(all_of(ps1), all_of(ps2), C0)
...
dat_q3_random = dat_random %>%
  filter(C0 >= cutoffs_50_75_random[1] & C0 <= cutoffs_50_75_random[2]) %>%
  select(all_of(ps1), all_of(ps2), C0)
...
dat_q4_random = dat_random %>%
  filter(C0 >= cutoffs_75_100_random[1] & C0 <= cutoffs_75_100_random[2]) %>%
  select(all_of(ps1), all_of(ps2), C0)
...
ggsave("~/Documents/Northwestern/DNA_Cyclizability/figures/mutual_information/random_ps2_q1_heatmap.png", plot = map_q1_random)
ggsave("~/Documents/Northwestern/DNA_Cyclizability/figures/mutual_information/random_ps2_q2_heatmap.png", plot = map_q2_random)
ggsave("~/Documents/Northwestern/DNA_Cyclizability/figures/mutual_information/random_ps2_q3_heatmap.png", plot = map_q3_random)
ggsave("~/Documents/Northwestern/DNA_Cyclizability/figures/mutual_information/random_ps2_q4_heatmap.png", plot = map_q4_random)
