...
parameter_list <- list(learning_rate = c(0.01),
...
saveRDS(subset_eval[[1]]$results, "lgbm/results/train-ps1-int-no-ratio-2-results.rds")

saveRDS(subset_eval, "lgbm/results/train-ps1-int-no-ratio-2-subset-eval.rds")
