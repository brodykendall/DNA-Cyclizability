...
model_cols <- c(ps1, ps2, ps3, ps4, ps5, nucleotides, dinucleotides, trinucleotides, 
                thermo_feat, "gc_count", "ratio_score_2nd", ps_int1, ps_int2)
...
saveRDS(subset_eval[[1]]$results, "lgbm/results/train-all-int-2-results.rds")

saveRDS(subset_eval, "lgbm/results/train-all-int-2-subset-eval.rds")
