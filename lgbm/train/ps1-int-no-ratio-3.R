...
saveRDS(subset_eval[[1]]$results, "lgbm/results/train-ps1-int-no-ratio-3-results.rds")

saveRDS(subset_eval, "lgbm/results/train-ps1-int-no-ratio-3-subset-eval.rds")
