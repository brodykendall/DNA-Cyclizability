...
saveRDS(subset_eval[[1]]$results, "lgbm/results/train-ps2-int-no-ratio-1-results.rds")

saveRDS(subset_eval, "lgbm/results/train-ps2-int-no-ratio-1-subset-eval.rds")
