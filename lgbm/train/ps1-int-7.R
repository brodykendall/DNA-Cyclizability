...
model_cols <- c(ps1, ps2, ps3, ps4, ps5, nucleotides, dinucleotides, trinucleotides, 
                thermo_feat, "gc_count", "ratio_score_2nd", ps_int1)
...
saveRDS(subset_eval[[1]]$results, "lgbm/results/train-ps1-int-7-results.rds")

saveRDS(subset_eval, "lgbm/results/train-ps1-int-7-subset-eval.rds")
