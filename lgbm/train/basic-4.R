...
model_cols <- c(ps1, ps2, ps3, nucleotides, dinucleotides, trinucleotides, thermo_feat, "gc_count", "ratio_score_2nd")
...
saveRDS(subset_eval, "lgbm/results/train-basic-4-subset-eval.rds")
