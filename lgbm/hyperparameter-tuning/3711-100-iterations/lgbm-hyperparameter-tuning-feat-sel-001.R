...
model_cols <- c(ps1, ps2, int3, int7, int11, nucleotides, dinucleotides, trinucleotides, thermo_feat, "gc_count", "ratio_score_2nd")
...
write_csv(subset_results,
          paste0("tuning/hyperparameter-results-feat-sel-001-", arg_index, ".csv"))
