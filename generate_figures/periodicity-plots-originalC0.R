...
nuc_AT_original_C0_plot_list = construct_periodicity_plots_AT(
  dat_nuc, C0, ylims_quartiles=nuc_ylims_quartiles, ylims_1000s=nuc_ylims_1000s,
  include_title=FALSE)

nuc_AT_original_C0_plot_list[[1]]
nuc_AT_original_C0_plot_list[[3]]
...
random_AT_original_C0_plot_list = construct_periodicity_plots_AT(
  dat_random, C0, ylims_quartiles=random_ylims_quartiles, ylims_1000s=random_ylims_1000s,
  include_title=FALSE)
...
tiling_AT_original_C0_plot_list = construct_periodicity_plots_AT(
  dat_tiling, C0, ylims_quartiles=tiling_ylims_quartiles, ylims_1000s=tiling_ylims_1000s,
  include_title=FALSE)
...
chrv_AT_original_C0_plot_list = construct_periodicity_plots_AT(
  dat_chrv, C0, ylims_quartiles=chrv_ylims_quartiles, ylims_1000s=chrv_ylims_1000s,
...
grid.arrange(nuc_AT_original_C0_plot_list[[1]], random_AT_original_C0_plot_list[[1]],
             tiling_AT_original_C0_plot_list[[1]], chrv_AT_original_C0_plot_list[[1]])
...
nuc_AATT_original_C0_plot_list[[3]]
...
random_AATT_original_C0_plot_list[[3]]
...
tiling_AATT_original_C26_plot_list = construct_periodicity_plots_AA_TT_AT_TA(
  dat_tiling, C26, ylims_quartiles=c(0.3, 0.5), ylims_1000s=tiling_ylims_di_1000s,
  include_title=FALSE, include_labels=FALSE, include_legend=FALSE)

tiling_AATT_original_C26_plot_list[[1]]
tiling_AATT_original_C26_plot_list[[3]]

tiling_AATT_original_C29_plot_list = construct_periodicity_plots_AA_TT_AT_TA(
  dat_tiling, C29, ylims_quartiles=c(0.3, 0.5), ylims_1000s=tiling_ylims_di_1000s,
  include_title=FALSE, include_labels=FALSE, include_legend=FALSE)

tiling_AATT_original_C29_plot_list[[1]]
tiling_AATT_original_C29_plot_list[[3]]

tiling_AATT_original_C31_plot_list = construct_periodicity_plots_AA_TT_AT_TA(
  dat_tiling, C31, ylims_quartiles=c(0.3, 0.5), ylims_1000s=tiling_ylims_di_1000s,
  include_title=FALSE, include_labels=FALSE, include_legend=FALSE)

tiling_AATT_original_C31_plot_list[[1]]
tiling_AATT_original_C31_plot_list[[3]]
...
chrv_AATT_original_C0_plot_list[[3]]


chrv_AATT_original_C26_plot_list = construct_periodicity_plots_AA_TT_AT_TA(
  dat_chrv, C26, ylims_quartiles=c(0.3, 0.5), ylims_1000s=chrv_ylims_di_1000s,
  include_title=FALSE, include_labels=FALSE, include_legend=FALSE)

chrv_AATT_original_C26_plot_list[[1]]
chrv_AATT_original_C26_plot_list[[3]]

chrv_AATT_original_C29_plot_list = construct_periodicity_plots_AA_TT_AT_TA(
  dat_chrv, C29, ylims_quartiles=c(0.3, 0.5), ylims_1000s=chrv_ylims_di_1000s,
  include_title=FALSE, include_labels=FALSE, include_legend=FALSE)

chrv_AATT_original_C29_plot_list[[1]]
chrv_AATT_original_C29_plot_list[[3]]

chrv_AATT_original_C31_plot_list = construct_periodicity_plots_AA_TT_AT_TA(
  dat_chrv, C31, ylims_quartiles=c(0.3, 0.5), ylims_1000s=chrv_ylims_di_1000s,
  include_title=FALSE, include_labels=FALSE, include_legend=FALSE)

chrv_AATT_original_C31_plot_list[[1]]
chrv_AATT_original_C31_plot_list[[3]]




grid.arrange(nuc_AATT_original_C0_plot_list[[1]], random_AATT_original_C0_plot_list[[1]],
             tiling_AATT_original_C0_plot_list[[1]], chrv_AATT_original_C0_plot_list[[1]])
