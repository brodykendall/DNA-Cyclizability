...
HRI_AA_tiling = data.frame(map(HRI_AA, get))
colnames(HRI_AA_tiling) = HRI_AA
saveRDS(HRI_AA_tiling, "data/Created/tiling_HRI_AA.rds")
...
HRI_AC_tiling = data.frame(map(HRI_AC, get))
colnames(HRI_AC_tiling) = HRI_AC
saveRDS(HRI_AC_tiling, "data/Created/tiling_HRI_AC.rds")
...
HRI_AG_tiling = data.frame(map(HRI_AG, get))
colnames(HRI_AG_tiling) = HRI_AG
saveRDS(HRI_AG_tiling, "data/Created/tiling_HRI_AG.rds")
...
HRI_AT_tiling = data.frame(map(HRI_AT, get))
colnames(HRI_AT_tiling) = HRI_AT
saveRDS(HRI_AT_tiling, "data/Created/tiling_HRI_AT.rds")
...
HRI_CA_tiling = data.frame(map(HRI_CA, get))
colnames(HRI_CA_tiling) = HRI_CA
saveRDS(HRI_CA_tiling, "data/Created/tiling_HRI_CA.rds")
...
HRI_CC_tiling = data.frame(map(HRI_CC, get))
colnames(HRI_CC_tiling) = HRI_CC
saveRDS(HRI_CC_tiling, "data/Created/tiling_HRI_CC.rds")
...
HRI_CG_tiling = data.frame(map(HRI_CG, get))
colnames(HRI_CG_tiling) = HRI_CG
saveRDS(HRI_CG_tiling, "data/Created/tiling_HRI_CG.rds")
...
HRI_CT_tiling = data.frame(map(HRI_CT, get))
colnames(HRI_CT_tiling) = HRI_CT
saveRDS(HRI_CT_tiling, "data/Created/tiling_HRI_CT.rds")
...
HRI_GA_tiling = data.frame(map(HRI_GA, get))
colnames(HRI_GA_tiling) = HRI_GA
saveRDS(HRI_GA_tiling, "data/Created/tiling_HRI_GA.rds")
...
HRI_GC_tiling = data.frame(map(HRI_GC, get))
colnames(HRI_GC_tiling) = HRI_GC
saveRDS(HRI_GC_tiling, "data/Created/tiling_HRI_GC.rds")
...
HRI_GG_tiling = data.frame(map(HRI_GG, get))
colnames(HRI_GG_tiling) = HRI_GG
saveRDS(HRI_GG_tiling, "data/Created/tiling_HRI_GG.rds")
...
HRI_GT_tiling = data.frame(map(HRI_GT, get))
colnames(HRI_GT_tiling) = HRI_GT
saveRDS(HRI_GT_tiling, "data/Created/tiling_HRI_GT.rds")
...
HRI_TA_tiling = data.frame(map(HRI_TA, get))
colnames(HRI_TA_tiling) = HRI_TA
saveRDS(HRI_TA_tiling, "data/Created/tiling_HRI_TA.rds")
...
HRI_TC_tiling = data.frame(map(HRI_TC, get))
colnames(HRI_TC_tiling) = HRI_TC
saveRDS(HRI_TC_tiling, "data/Created/tiling_HRI_TC.rds")
...
HRI_TG_tiling = data.frame(map(HRI_TG, get))
colnames(HRI_TG_tiling) = HRI_TG
saveRDS(HRI_TG_tiling, "data/Created/tiling_HRI_TG.rds")

HRI_TT_TT = apply(dat, 1, find_HRI, di1="TT", di2="TT")

HRI_TT_tiling = data.frame(HRI_TT_TT)
colnames(HRI_TT_tiling) = "HRI_TT_TT"
saveRDS(HRI_TT_tiling, "data/Created/tiling_HRI_TT.rds")

HRI = data.frame(map(paste0("HRI_", dinucleotides, "_tiling"), get))
saveRDS(HRI, "data/Created/tiling_HRI.rds")
...
HRI_AA_tiling_test = data.frame(map(HRI_AA_test, get))
colnames(HRI_AA_tiling_test) = paste0("HRI_AA_", dinucleotides)
saveRDS(HRI_AA_tiling_test, "data/Created/tiling_HRI_AA_test.rds")
...
HRI_AC_tiling_test = data.frame(map(HRI_AC_test, get))
colnames(HRI_AC_tiling_test) = paste0("HRI_AC_", dinucleotides[-1])
saveRDS(HRI_AC_tiling_test, "data/Created/tiling_HRI_AC_test.rds")
...
HRI_AG_tiling_test = data.frame(map(HRI_AG_test, get))
colnames(HRI_AG_tiling_test) = paste0("HRI_AG_", dinucleotides[-(1:2)])
saveRDS(HRI_AG_tiling_test, "data/Created/tiling_HRI_AG_test.rds")
...
HRI_AT_tiling_test = data.frame(map(HRI_AT_test, get))
colnames(HRI_AT_tiling_test) = paste0("HRI_AT_", dinucleotides[-(1:3)])
saveRDS(HRI_AT_tiling_test, "data/Created/tiling_HRI_AT_test.rds")
...
HRI_CA_tiling_test = data.frame(map(HRI_CA_test, get))
colnames(HRI_CA_tiling_test) = paste0("HRI_CA_", dinucleotides[-(1:4)])
saveRDS(HRI_CA_tiling_test, "data/Created/tiling_HRI_CA_test.rds")
...
HRI_CC_tiling_test = data.frame(map(HRI_CC_test, get))
colnames(HRI_CC_tiling_test) = paste0("HRI_CC_", dinucleotides[-(1:5)])
saveRDS(HRI_CC_tiling_test, "data/Created/tiling_HRI_CC_test.rds")
...
HRI_CG_tiling_test = data.frame(map(HRI_CG_test, get))
colnames(HRI_CG_tiling_test) = paste0("HRI_CG_", dinucleotides[-(1:6)])
saveRDS(HRI_CG_tiling_test, "data/Created/tiling_HRI_CG_test.rds")
...
HRI_CT_tiling_test = data.frame(map(HRI_CT_test, get))
colnames(HRI_CT_tiling_test) = paste0("HRI_CT_", dinucleotides[-(1:7)])
saveRDS(HRI_CT_tiling_test, "data/Created/tiling_HRI_CT_test.rds")
...
HRI_GA_tiling_test = data.frame(map(HRI_GA_test, get))
colnames(HRI_GA_tiling_test) = paste0("HRI_GA_", dinucleotides[-(1:8)])
saveRDS(HRI_GA_tiling_test, "data/Created/tiling_HRI_GA_test.rds")
...
HRI_GC_tiling_test = data.frame(map(HRI_GC_test, get))
colnames(HRI_GC_tiling_test) = paste0("HRI_GC_", dinucleotides[-(1:9)])
saveRDS(HRI_GC_tiling_test, "data/Created/tiling_HRI_GC_test.rds")
...
HRI_GG_tiling_test = data.frame(map(HRI_GG_test, get))
colnames(HRI_GG_tiling_test) = paste0("HRI_GG_", dinucleotides[-(1:10)])
saveRDS(HRI_GG_tiling_test, "data/Created/tiling_HRI_GG_test.rds")
...
HRI_GT_tiling_test = data.frame(map(HRI_GT_test, get))
colnames(HRI_GT_tiling_test) = paste0("HRI_GT_", dinucleotides[-(1:11)])
saveRDS(HRI_GT_tiling_test, "data/Created/tiling_HRI_GT_test.rds")
...
HRI_TA_tiling_test = data.frame(map(HRI_TA_test, get))
colnames(HRI_TA_tiling_test) = paste0("HRI_TA_", dinucleotides[-(1:12)])
saveRDS(HRI_TA_tiling_test, "data/Created/tiling_HRI_TA_test.rds")
...
HRI_TC_tiling_test = data.frame(map(HRI_TC_test, get))
colnames(HRI_TC_tiling_test) = paste0("HRI_TC_", dinucleotides[-(1:13)])
saveRDS(HRI_TC_tiling_test, "data/Created/tiling_HRI_TC_test.rds")
...
HRI_TG_tiling_test = data.frame(map(HRI_TG_test, get))
colnames(HRI_TG_tiling_test) = paste0("HRI_TG_", dinucleotides[-(1:14)])
saveRDS(HRI_TG_tiling_test, "data/Created/tiling_HRI_TG_test.rds")

HRI_TT_TT_test = apply(dat_test, 1, find_HRI, di1="TT", di2="TT")

HRI_TT_tiling_test = data.frame(HRI_TT_TT_test)
colnames(HRI_TT_tiling_test) = "HRI_TT_TT"
saveRDS(HRI_TT_tiling_test, "data/Created/tiling_HRI_TT_test.rds")

HRI_test = data.frame(map(paste0("HRI_", dinucleotides, "_tiling_test"), get))
saveRDS(HRI_test, "data/Created/tiling_HRI_test.rds")
