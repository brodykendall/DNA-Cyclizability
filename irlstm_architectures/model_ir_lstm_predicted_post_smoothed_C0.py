...
model_name = "ir_lstm_predicted_post_smoothed_C0"
...
data_cerevisiae_nucle = pd.read_csv("/Users/Brody1/Dropbox/Northwestern/DNA_Cyclizability/data/Created/cycle1_predicted_smooth_C0.csv",delimiter = ",")
X1 = []
...
Y1 = data_cerevisiae_nucle["predicted_smooth_C0"].values.astype(float)

data_random_library = pd.read_csv("/Users/Brody1/Dropbox/Northwestern/DNA_Cyclizability/data/Created/cycle3_predicted_smooth_C0.csv",delimiter = ",")
X3 = []
...
Y3 = data_random_library["predicted_smooth_C0"].values.astype(float)

data_tiling = pd.read_csv("/Users/Brody1/Dropbox/Northwestern/DNA_Cyclizability/data/Created/cycle5_predicted_smooth_C0.csv",delimiter = ",")
X5 = []
...
Y5 = data_tiling["predicted_smooth_C0"].values.astype(float)

data_chr5 = pd.read_csv("/Users/Brody1/Dropbox/Northwestern/DNA_Cyclizability/data/Created/cycle6_predicted_smooth_C0.csv",delimiter = ",")
X6 = []
...
Y6 = data_chr5["predicted_smooth_C0"].values.astype(float)
