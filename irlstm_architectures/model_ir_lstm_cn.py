...
model_name = "ir_lstm_c26"
# model_name = "ir_lstm_c29"
# model_name = "ir_lstm_c31"
...
Y1 = data_cerevisiae_nucle["n=26"].values.astype(float)
# Y1 = data_cerevisiae_nucle["n=29"].values.astype(float)
# Y1 = data_cerevisiae_nucle["n=31"].values.astype(float)
...
Y3 = data_random_library["n=26"].values.astype(float)
# Y3 = data_random_library["n=29"].values.astype(float)
# Y3 = data_random_library["n=31"].values.astype(float)
...
Y5 = data_tiling["n=26"].values.astype(float)
# Y5 = data_tiling["n=29"].values.astype(float)
# Y5 = data_tiling["n=31"].values.astype(float)
...
Y6 = data_chr5["n=26"].values.astype(float)
# Y6 = data_chr5["n=29"].values.astype(float)
# Y6 = data_chr5["n=31"].values.astype(float)
